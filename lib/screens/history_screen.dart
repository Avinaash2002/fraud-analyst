      ...
      child: Row(children: [
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            Text('${(item.riskScore * 100).toStringAsFixed(0)}%', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: isFraud ? const Color(0xFFEF4444) : Colors.grey.shade500)),
          ]),
        ])),
        ...
        return Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _DetailRow(label: 'Risk Score', value: '${(item.riskScore * 100).toStringAsFixed(1)}%'),
